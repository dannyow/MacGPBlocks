...
//                  Morph owner parts  handler bounds costume costumeData transformedCostume costumeChanged isVisible alpha grabRule noticesTransparentTouch isClipping minWidth minHeight fps lastStepTime acceptsEvents penTrails penTrailsData tag param pen drawOnOwner rotation rotateWithOwner scaleX scaleY pinX pinY vectorPen shouldRedraw
//(initialize (new 'Morph' nil  (list) handler (rect) nil     nil         nil                false          true      255   'defer'  false                   false      1        1         nil  nil         true))
to newMorph handler {
